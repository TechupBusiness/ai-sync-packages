---
name: commit
description: Git commit using Conventional Commits format
---
...
```bash
git add abc123.ts src/ && git commit -m "feat(loaders): add Claude plugin loader for native Claude format
...
- [ ] Make sure to include all changes from that coding session / feature etc.
